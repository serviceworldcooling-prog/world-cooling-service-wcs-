...
export const MOCK_BOOKINGS: Booking[] = [
  { id: 'B001', customerId: 'C001', customerName: 'James Wilson', customerPhone: '+1 555-0101', customerAvatar: '', technicianId: 'T001', technicianName: 'Alex Johnson', technicianAvatar: 'https://images.unsplash.com/photo-1540569014015-19a7be504e3a?w=80', service: 'AC Repair', date: '2026-07-20', time: '10:00 AM', status: 'Upcoming', price: 99, address: '124 Ocean Drive, Apt 4B, Miami, FL', description: 'Cooling is very low, making clicking noises.', paymentMethod: 'Card', invoiceId: 'INV-001' },
  { id: 'B002', customerId: 'C002', customerName: 'Sophia Martinez', customerPhone: '+1 555-0102', customerAvatar: '', technicianId: 'T002', technicianName: 'Marcus Chen', technicianAvatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=80', service: 'AC Service', date: '2026-07-18', time: '02:00 PM', status: 'Completed', price: 49, address: 'Suite 900, 500 Brickell Ave, Miami, FL', description: 'Routine service check.', paymentMethod: 'UPI', invoiceId: 'INV-002' },
  { id: 'B003', customerId: 'C003', customerName: 'Ethan Brown', customerPhone: '+1 555-0103', customerAvatar: '', technicianId: 'T003', technicianName: 'David Smith', technicianAvatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=80', service: 'Gas Charging', date: '2026-07-18', time: '11:30 AM', status: 'In Progress', price: 99, address: '780 NW 42nd Ave, Miami, FL', description: 'Gas refill and leak check R410A.', paymentMethod: 'Wallet', invoiceId: 'INV-003' },
  { id: 'B004', customerId: 'C004', customerName: 'Olivia Davis', customerPhone: '+1 555-0104', customerAvatar: '', technicianId: 'T001', technicianName: 'Alex Johnson', technicianAvatar: 'https://images.unsplash.com/photo-1540569014015-19a7be504e3a?w=80', service: 'AC Installation', date: '2026-07-17', time: '09:00 AM', status: 'Completed', price: 149, address: '2200 Collins Ave, Miami Beach, FL', description: 'New split AC 1.5 ton installation.', paymentMethod: 'Card', invoiceId: 'INV-004' },
  { id: 'B005', customerId: 'C005', customerName: 'Noah Garcia', customerPhone: '+1 555-0105', customerAvatar: '', technicianId: 'T002', technicianName: 'Marcus Chen', technicianAvatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=80', service: 'Jet Cleaning', date: '2026-07-16', time: '03:00 PM', status: 'Cancelled', price: 59, address: '100 Miracle Mile, Coral Gables, FL', description: 'Deep jet cleaning requested.', paymentMethod: 'UPI', invoiceId: 'INV-005' },
  { id: 'B006', customerId: 'C006', customerName: 'Emma Thompson', customerPhone: '+1 555-0106', customerAvatar: '', technicianId: 'T003', technicianName: 'David Smith', technicianAvatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=80', service: 'Water Leakage', date: '2026-07-21', time: '10:30 AM', status: 'Upcoming', price: 39, address: '3301 SW 27th Ave, Miami, FL', description: 'Water dripping from indoor unit.', paymentMethod: 'Card', invoiceId: 'INV-006' },
  { id: 'B007', customerId: 'C001', customerName: 'James Wilson', customerPhone: '+1 555-0101', customerAvatar: '', technicianId: 'T001', technicianName: 'Alex Johnson', technicianAvatar: 'https://images.unsplash.com/photo-1540569014015-19a7be504e3a?w=80', service: 'PCB Repair', date: '2026-07-15', time: '01:00 PM', status: 'Completed', price: 119, address: '124 Ocean Drive, Apt 4B, Miami, FL', description: 'Main board not responding.', paymentMethod: 'Card', invoiceId: 'INV-007' },
  { id: 'B008', customerId: 'C007', customerName: 'Liam Anderson', customerPhone: '+1 555-0107', customerAvatar: '', technicianId: 'T002', technicianName: 'Marcus Chen', technicianAvatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=80', service: 'Compressor Repair', date: '2026-07-22', time: '08:00 AM', status: 'Upcoming', price: 199, address: '1900 Biscayne Blvd, Miami, FL', description: 'Compressor making grinding sound.', paymentMethod: 'Card', invoiceId: 'INV-008' },
];

export const MOCK_CUSTOMERS: Customer[] = [
  { id: 'C001', name: 'James Wilson', email: 'james.wilson@email.com', phone: '+1 555-0101', avatar: '', status: 'Active', joinDate: '2025-03-12', totalBookings: 7, totalSpent: 642, hasMembership: true, walletBalance: 45, addresses: ['124 Ocean Drive, Apt 4B, Miami, FL'], city: 'Miami' },
  { id: 'C002', name: 'Sophia Martinez', email: 'sophia.m@email.com', phone: '+1 555-0102', avatar: '', status: 'Active', joinDate: '2025-05-08', totalBookings: 4, totalSpent: 278, hasMembership: false, walletBalance: 120, addresses: ['Suite 900, 500 Brickell Ave, Miami, FL'], city: 'Miami' },
  { id: 'C003', name: 'Ethan Brown', email: 'ethan.b@email.com', phone: '+1 555-0103', avatar: '', status: 'Active', joinDate: '2025-01-20', totalBookings: 12, totalSpent: 1140, hasMembership: true, walletBalance: 200, addresses: ['780 NW 42nd Ave, Miami, FL'], city: 'Miami' },
  { id: 'C004', name: 'Olivia Davis', email: 'olivia.d@email.com', phone: '+1 555-0104', avatar: '', status: 'Active', joinDate: '2025-06-15', totalBookings: 3, totalSpent: 298, hasMembership: false, walletBalance: 0, addresses: ['2200 Collins Ave, Miami Beach, FL'], city: 'Miami Beach' },
  { id: 'C005', name: 'Noah Garcia', email: 'noah.g@email.com', phone: '+1 555-0105', avatar: '', status: 'Inactive', joinDate: '2025-02-28', totalBookings: 2, totalSpent: 108, hasMembership: false, walletBalance: 10, addresses: ['100 Miracle Mile, Coral Gables, FL'], city: 'Coral Gables' },
  { id: 'C006', name: 'Emma Thompson', email: 'emma.t@email.com', phone: '+1 555-0106', avatar: '', status: 'Active', joinDate: '2026-01-10', totalBookings: 5, totalSpent: 392, hasMembership: true, walletBalance: 75, addresses: ['3301 SW 27th Ave, Miami, FL'], city: 'Miami' },
  { id: 'C007', name: 'Liam Anderson', email: 'liam.a@email.com', phone: '+1 555-0107', avatar: '', status: 'Active', joinDate: '2025-09-05', totalBookings: 9, totalSpent: 876, hasMembership: true, walletBalance: 150, addresses: ['1900 Biscayne Blvd, Miami, FL'], city: 'Miami' },
  { id: 'C008', name: 'Ava Robinson', email: 'ava.r@email.com', phone: '+1 555-0108', avatar: '', status: 'Inactive', joinDate: '2025-04-18', totalBookings: 1, totalSpent: 49, hasMembership: false, walletBalance: 0, addresses: ['5555 SW 8th St, Miami, FL'], city: 'Miami' },
];

export const MOCK_TECHNICIANS: Technician[] = [
  { id: 'T001', name: 'Alex Johnson', email: 'alex.j@acservice.com', phone: '+1 555-0199', avatar: '', specialty: 'Master HVAC Technician', rating: 4.9, completedJobs: 1240, status: 'On Job', joinDate: '2024-01-15', earnings: 48200, city: 'Miami', certifications: ['EPA 608', 'NATE Certified', 'HVAC Excellence'], activeBookingId: 'B001' },
  { id: 'T002', name: 'Marcus Chen', email: 'marcus.c@acservice.com', phone: '+1 555-0188', avatar: '', specialty: 'Cooling & Gas Specialist', rating: 4.8, completedJobs: 890, status: 'Available', joinDate: '2024-03-10', earnings: 36700, city: 'Miami', certifications: ['EPA 608', 'R410A Certified'] },
  { id: 'T003', name: 'David Smith', email: 'david.s@acservice.com', phone: '+1 555-0177', avatar: '', specialty: 'Installation Expert', rating: 4.7, completedJobs: 650, status: 'Available', joinDate: '2024-06-20', earnings: 27400, city: 'Miami Beach', certifications: ['EPA 608', 'NATE Certified'] },
  { id: 'T004', name: 'Carlos Rivera', email: 'carlos.r@acservice.com', phone: '+1 555-0166', avatar: '', specialty: 'PCB & Electrical Specialist', rating: 4.6, completedJobs: 420, status: 'Off Duty', joinDate: '2025-01-08', earnings: 18900, city: 'Coral Gables', certifications: ['EPA 608', 'Electronics Certification'] },
  { id: 'T005', name: 'Ryan Patel', email: 'ryan.p@acservice.com', phone: '+1 555-0155', avatar: '', specialty: 'Multi-Brand Specialist', rating: 4.9, completedJobs: 780, status: 'On Job', joinDate: '2024-08-14', earnings: 33100, city: 'Miami', certifications: ['EPA 608', 'NATE Certified', 'Daikin Certified'], activeBookingId: 'B003' },
];
...
export const MOCK_OFFERS: Offer[] = [
  ...
  { id: 'O003', title: 'Welcome Offer', code: 'WELCOME30', discount: 30, discountType: 'flat', description: 'Flat ₹300 off your first service request', expiry: '2026-12-31', usageCount: 312, maxUsage: 1000, isActive: true, minOrderValue: 50 },
  ...
  { id: 'O005', title: 'Referral Bonus', code: 'REFER50', discount: 50, discountType: 'flat', description: 'Refer a friend and both get ₹500 off', expiry: '2026-12-31', usageCount: 67, maxUsage: 500, isActive: true, minOrderValue: 79 },
];

export const MOCK_REVIEWS: Review[] = [
  { id: 'R001', customerId: 'C002', customerName: 'Sophia Martinez', customerAvatar: '', technicianId: 'T002', technicianName: 'Marcus Chen', bookingId: 'B002', service: 'AC Service', rating: 5, comment: 'Excellent service! Marcus was very professional and thorough. My AC is cooling much better now.', date: '2026-07-18', isPublished: true, reply: 'Thank you Sophia! We are glad you are happy with the service.' },
  { id: 'R002', customerId: 'C004', customerName: 'Olivia Davis', customerAvatar: '', technicianId: 'T001', technicianName: 'Alex Johnson', bookingId: 'B004', service: 'AC Installation', rating: 5, comment: 'Alex did an amazing job with the installation. Very clean work, no mess left behind!', date: '2026-07-17', isPublished: true },
  { id: 'R003', customerId: 'C001', customerName: 'James Wilson', customerAvatar: '', technicianId: 'T001', technicianName: 'Alex Johnson', bookingId: 'B007', service: 'PCB Repair', rating: 4, comment: 'Good work overall, took a bit longer than expected but the result is great.', date: '2026-07-15', isPublished: true },
  { id: 'R004', customerId: 'C007', customerName: 'Liam Anderson', customerAvatar: '', technicianId: 'T003', technicianName: 'David Smith', bookingId: 'B007', service: 'AC Repair', rating: 3, comment: 'Service was okay, but the technician arrived 30 minutes late. Issue got fixed though.', date: '2026-07-14', isPublished: false },
  { id: 'R005', customerId: 'C006', customerName: 'Emma Thompson', customerAvatar: '', technicianId: 'T005', technicianName: 'Ryan Patel', bookingId: 'B006', service: 'Gas Charging', rating: 5, comment: 'Ryan is phenomenal! Diagnosed the leak quickly and had it fixed in no time. Highly recommend!', date: '2026-07-13', isPublished: true },
];
...
export const MOCK_NOTIFICATIONS: Notification[] = [
  ...
  { id: 'N003', title: 'Payment Received', body: 'Your payment of ₹1,499 for AC Installation (INV-004) has been received. Thank you!', type: 'payment', targetAudience: 'customers', sentAt: '2026-07-17 06:00 PM', sentCount: 1, readCount: 1, status: 'sent' },
...
export const MOCK_TRANSACTIONS: Transaction[] = [
  { id: 'TXN001', customerId: 'C004', customerName: 'Olivia Davis', customerAvatar: '', type: 'credit', amount: 149, description: 'Payment for AC Installation (INV-004)', date: '2026-07-17', bookingId: 'B004', method: 'Credit Card', status: 'success' },
  { id: 'TXN002', customerId: 'C002', customerName: 'Sophia Martinez', customerAvatar: '', type: 'credit', amount: 49, description: 'Payment for AC Service (INV-002)', date: '2026-07-18', bookingId: 'B002', method: 'UPI', status: 'success' },
  { id: 'TXN003', customerId: 'C005', customerName: 'Noah Garcia', customerAvatar: '', type: 'refund', amount: 59, description: 'Refund for cancelled booking (B005)', date: '2026-07-16', bookingId: 'B005', method: 'UPI', status: 'success' },
  { id: 'TXN004', customerId: 'C003', customerName: 'Ethan Brown', customerAvatar: '', type: 'credit', amount: 179, description: 'AMC Gold Care Plan subscription', date: '2026-07-14', method: 'Credit Card', status: 'success' },
  { id: 'TXN005', customerId: 'C001', customerName: 'James Wilson', customerAvatar: '', type: 'debit', amount: 45, description: 'Wallet top-up deduction — service discount applied', date: '2026-07-15', bookingId: 'B007', method: 'Wallet', status: 'success' },
  { id: 'TXN006', customerId: 'C006', customerName: 'Emma Thompson', customerAvatar: '', type: 'credit', amount: 299, description: 'Premium Platinum AMC Plan (2 Years)', date: '2026-07-12', method: 'Credit Card', status: 'success' },
  { id: 'TXN007', customerId: 'C007', customerName: 'Liam Anderson', customerAvatar: '', type: 'credit', amount: 199, description: 'Payment for Compressor Repair (INV-008)', date: '2026-07-19', bookingId: 'B008', method: 'Credit Card', status: 'pending' },
];

// ─── New Mock Data ────────────────────────────────────────────────────────────

export const MOCK_COMPLAINTS: Complaint[] = [
  { id: 'CMP001', customerId: 'C001', customerName: 'James Wilson', customerAvatar: '', bookingId: 'B001', technicianName: 'Alex Johnson', subject: 'AC still not cooling after repair', description: 'I had AC Repair done yesterday but the unit is still not cooling properly. The technician said it was fixed but the problem persists.', status: 'Open', priority: 'High', category: 'Service Quality', date: '2026-07-19', adminNote: '' },
  { id: 'CMP002', customerId: 'C005', customerName: 'Noah Garcia', customerAvatar: '', bookingId: 'B005', technicianName: 'Marcus Chen', subject: 'Technician arrived 2 hours late', description: 'The scheduled time was 3:00 PM but technician arrived at 5:15 PM. No prior notification was given and the booking was eventually cancelled.', status: 'In Progress', priority: 'Medium', category: 'Punctuality', date: '2026-07-16', adminNote: 'Contacted technician. Investigating delay cause.' },
  { id: 'CMP003', customerId: 'C007', customerName: 'Liam Anderson', customerAvatar: '', subject: 'Overcharged for service', description: 'I was quoted ₹1,499 for AC Installation but was charged ₹1,999 at the end. No explanation was provided for the extra ₹500 charge.', status: 'Resolved', priority: 'Urgent', category: 'Billing', date: '2026-07-14', resolvedDate: '2026-07-16', adminNote: 'Refund of ₹500 processed.' },
  { id: 'CMP004', customerId: 'C003', customerName: 'Ethan Brown', customerAvatar: '', bookingId: 'B003', technicianName: 'David Smith', subject: 'Gas leak found after charging', description: 'After gas charging service, I noticed a small leak from the connection point. The technician may not have sealed it properly.', status: 'Open', priority: 'Urgent', category: 'Safety', date: '2026-07-18', adminNote: '' },
  { id: 'CMP005', customerId: 'C006', customerName: 'Emma Thompson', customerAvatar: '', subject: 'App not showing booking status', description: 'My booking B006 shows as Upcoming in the app but I received no technician details. The booking date is tomorrow.', status: 'Closed', priority: 'Low', category: 'App Issue', date: '2026-07-20', resolvedDate: '2026-07-20', adminNote: 'App sync issue resolved. Customer notified.' },
];

export const MOCK_REFERRALS: Referral[] = [
  { id: 'REF001', referrerId: 'C001', referrerName: 'James Wilson', referrerAvatar: '', referredName: 'Michael Scott', referredEmail: 'michael.s@email.com', referralCode: 'JAMES50', status: 'Completed', date: '2026-07-10', rewardAmount: 50, rewardPaid: true, bookingId: 'B009' },
  { id: 'REF002', referrerId: 'C003', referrerName: 'Ethan Brown', referrerAvatar: '', referredName: 'Sarah Connor', referredEmail: 'sarah.c@email.com', referralCode: 'ETHAN50', status: 'Pending', date: '2026-07-17', rewardAmount: 50, rewardPaid: false },
